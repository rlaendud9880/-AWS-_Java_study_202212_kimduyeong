...
insert into student_mst values (2, '김두영', 2);
insert into student_mst values (3, '장진원', 3);
...
insert into mentor_mst values (1, '김동민멘토');
insert into mentor_mst values (2, '문자영');
insert into mentor_mst values (3, '장진원멘토');
...
from
    ...
    left outer join mentor_mst mm on(mm.mentor_id = sm.mentro_id)
